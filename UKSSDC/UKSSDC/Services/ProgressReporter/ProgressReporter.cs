...
namespace UKSSDC.Services.ProgressReporter
{
    public class ProgressReporter : IProgressReporter
    {
        ...
        {
            if (path == "") //TODO: Take the path that the program is operating from or C:\\Places_CSV or the local path
            {
                path =
                    "C:\\Users\\Matthew\\Desktop\\Project\\Implementation\\Maps Data\\UKSSDC 2\\UKSSDC\\UKSSDC\\CSV";
            }
